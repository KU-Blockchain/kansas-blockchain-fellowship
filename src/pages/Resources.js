...
const class_lectures = [
  {
    title: "Week 6 - IPFS, Pinata, Farcaster",
    date: "July 18, 2024",
    embed:
      "<iframe id='kmsembed-1_fuygr8xo' width='500' height='385' src='https://mediahub.ku.edu/embed/secure/iframe/entryId/1_fuygr8xo/uiConfId/45147491/st/0' class='kmsembed' allowfullscreen webkitallowfullscreen mozAllowFullScreen allow='autoplay *; fullscreen *; encrypted-media *' referrerPolicy='no-referrer-when-downgrade' sandbox='allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation' frameborder='0' title='Kansas Blockchain Fellowship - Week 6'></iframe>",
    lecture_notes:
      "https://docs.google.com/presentation/d/1bU2qsQy9bbbMh5nZn0ElxUUGMf-5jfaocHeJWwPzJVE/edit?usp=sharing",
  },
  {
  ...
  },
  {
    ...
    date: "July 2, 2024",
    embed:
      "<iframe id='kmsembed-1_srjfr4sl' width='500' height='385' src='https://mediahub.ku.edu/embed/secure/iframe/entryId/1_srjfr4sl/uiConfId/45147491/st/0' class='kmsembed' allowfullscreen webkitallowfullscreen mozAllowFullScreen allow='autoplay *; fullscreen *; encrypted-media *' referrerPolicy='no-referrer-when-downgrade' sandbox='allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation' frameborder='0' title='Kansas Blockchain Fellowship - Week 4'></iframe>",
    lecture_notes:
      "https://docs.google.com/presentation/d/1ytGCSaOMSnIqeFuVfzgFTJC0SL7odW8mdmTi_CN_-Dg/edit?usp=sharing",
  },
  {
  ...
  },
  {
    ...
    date: "June 13, 2024",
    embed:
      "<iframe id='kmsembed-1_isz4j0s4' width='500' height='385' src='https://mediahub.ku.edu/embed/secure/iframe/entryId/1_isz4j0s4/uiConfId/45147491/st/0' class='kmsembed' allowfullscreen webkitallowfullscreen mozAllowFullScreen allow='autoplay *; fullscreen *; encrypted-media *' referrerPolicy='no-referrer-when-downgrade' sandbox='allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation' frameborder='0' title='Kansas Blockchain Fellowship Week 1 - Basics of Blockchain'></iframe>",
    lecture_notes:
      "https://docs.google.com/presentation/d/1gLhyHVXHAL1_CB1GORV1ETYatQHtWxElRAumrTQUtgE/edit?usp=sharing",
  },
  {
